...
export const BUILTIN_FILE_TYPES: readonly FileTypeDef[] = [
  ...
  { extension: ".md.html", label: "Study guide / page", class: "document", creatable: true },
  { extension: ".slides.html", label: "Slide deck", class: "document", creatable: true },
  { extension: ".paged.html", label: "Print document", class: "document", creatable: true },
  { extension: ".html", label: "Web page", class: "document", creatable: true },
  // Insertable images.
  { extension: ".ketcher.svg", label: "Chemical structure", class: "insertable-image", creatable: true },
  { extension: ".plot.svg", label: "Plot", class: "insertable-image", creatable: true },
  ...
  { extension: ".md", label: "Markdown", class: "insertable-source", creatable: true },
