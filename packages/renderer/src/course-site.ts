...
// Copy-as-source is provided by orz-markdown's browser runtime (inlined by
// `themedDocument`): select rendered content and Cmd/Ctrl-C yields Markdown —
// the same built-in mechanism as `.md.html`. No page-specific button needed.
